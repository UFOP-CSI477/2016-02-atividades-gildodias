 ...
 */
    ...
    class usuariosPage extends Page
    {
        ...
        public function GetPageList()
        {
            ...
            $result->AddGroup($this->RenderText('Default'));
             if (GetCurrentUserGrantForDataSource('usuarios')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('Usuarios'), 'usuarios.php', $this->RenderText('Usuarios'), $currentPageCaption == $this->RenderText('Usuarios'), false, $this->RenderText('Default')));
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('usuariosssearch', $this->dataset,
                array('id', 'nome', 'login', 'senha', 'tipo'),
                array($this->RenderText('Id'), $this->RenderText('Nome'), $this->RenderText('Login'), $this->RenderText('Senha'), $this->RenderText('Tipo')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('usuariosasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'usuarios_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'usuariosGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new usuariosPage("usuarios.php", "usuarios", GetCurrentUserGrantForDataSource("usuarios"), 'UTF-8');
        $Page->SetShortCaption('Usuarios');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Usuarios');
