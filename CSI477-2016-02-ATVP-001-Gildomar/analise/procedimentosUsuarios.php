 ...
 */
    ...
    class procedimentosPage extends Page
    {
        ...
        public function GetPageList()
        {
            ...
            if (GetCurrentUserGrantForDataSource('procedimentos')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('Procedimentos'), 'procedimentosUsuarios.php', $this->RenderText('Procedimentos'), $currentPageCaption == $this->RenderText('Procedimentos'), false, $this->RenderText('Default')));
    ...
    try
    {
        $Page = new procedimentosPage("procedimentosUsuarios.php", "procedimentos", GetCurrentUserGrantForDataSource("procedimentos"), 'UTF-8');
